...
@section('main')
   <div class="px-3">  
            <div class="theme-container">  
                <div class="my-5">
                    ...
                    <div class="mdc-card p-5 my-3">
                        <p>The following terminology applies to these Terms and Conditions, Privacy Statement and Disclaimer Notice and any
                            or all Agreements: "Client","User", “You” and “Your” refers to you, the person accessing this website and accepting the
              ...
              <ul class="px-3">
                <li>When you register for Masela we ask for information such as your Company name, email address, billing address, credit card information. Members who sign up for the free account are not required to enter a credit card.</li>
                <li>Safariplanner uses collected information for the following general purposes: products and services provision, billing, identification and authentication, services improvement, contact, and research.</li>
              </ul>
                          ...
                          <h3>Question</h3>
              <p>Any questions about this Privacy Policy should be addressed to admin@vinuru.com</p>
                          ...
                          <p class="text-right">© Masela Inc 2021 All Rights Reserved </p>
                    </div> 
                </div> 
            </div>  
        </div> 
