                ...
                <form id="new-operator" action="" method="POST">
                    ...
                    <div class="form-row">
                        <div class="col-md-8 form-group">
                            <input class="form-control" id="companyname" value="{{$operator_data['name']}}" type="text" name="name" placeholder="Company Name">
                        </div>
                        <div class="col-md-8 form-group">
                        ...
                        <div class="col-md-8 form-group">
                            <input class="form-control " id="companyemail" value="{{$operator_data['email']}}" name="email" type="text" placeholder="Contact Email">
                        </div>

                        <div class="col-md-8 form-group">
                            <input class="form-control " id="companymobile" value="{{$operator_data['mobile']}}" name="Mobile No" type="text" placeholder="Contact Number">
                        </div>
                        ...
                        <div class="col-8 form-group">
                            <textarea class="form-control" name="description" id="companyintro" placeholder="Short Description of your company." rows="5"></textarea>
                        </div>
